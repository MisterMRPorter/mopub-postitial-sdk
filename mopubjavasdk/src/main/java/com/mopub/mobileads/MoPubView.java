...
public class MoPubView extends FrameLayout {
    ...
    protected void loadCustomEvent(String customEventClassName, Map<String, String> serverExtras) {
        ...
        Log.d("MoPub", "Custom event name = " + customEventClassName);
        ...
        if(mAdViewController.isPostitial()) {
            for(String iterateHolderVariable : unsupportedPostitialNetworks) {
                if(customEventClassName.toLowerCase().startsWith(iterateHolderVariable.toLowerCase())) {
        ...
        mCustomEventBannerAdapter.setAdViewController(mAdViewController);
    ...
    protected void onVideoPlayed(String url) {
    	if (mBannerAdListener != null) {
    		mBannerAdListener.onVideoPlayed(url);
    	}
    }
    
	public void closePostitialSession() {
    	if (mBannerAdListener != null) {
    		mBannerAdListener.onClosePostitialSession(this);
    	}		
	}
	...
	public void setPostitial(boolean isPostitial) {
		this.mAdViewController.setPostitial(isPostitial);
	}
	
	public void setHolder(ViewGroup holder) {
	    this.mAdViewController.setHolder(holder);
	}
	
	public boolean getPostitial() {
		return this.mAdViewController.isPostitial();
	}
