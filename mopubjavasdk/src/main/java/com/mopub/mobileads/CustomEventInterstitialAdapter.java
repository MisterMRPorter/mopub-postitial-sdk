...
public class CustomEventInterstitialAdapter implements CustomEventInterstitialListener {
    ...
    View showInterstitialView(ViewGroup holder, AdViewController adViewController) {
        if (isInvalidated() || mCustomEventInterstitial == null) {
        	return null;
        }else{
            return mCustomEventInterstitial.showInterstitialView(holder, adViewController);
        }
    }
	...
	public void onClosePostitialSession() {
		mCustomEventInterstitialAdapterListener.onClosePostitialSession();
		
	}

	@Override
	public void onVideoPlayed(String url) {
		mCustomEventInterstitialAdapterListener.onVideoPlayed(url);
