...
public class CustomEventBannerAdapter implements CustomEventBannerListener {
    ...
    void loadAd() {
        ...
        mCustomEventBanner.setAdViewController(adViewController);
	...
	public void onVideoPlayed(String url) {
		...
		mMoPubView.onVideoPlayed(url);
	}

	@Override
	public void onClosePostitialSession() {
		
		mMoPubView.closePostitialSession();
		
	}

	public void setAdViewController(AdViewController mAdViewController) {
		
		this.adViewController = mAdViewController;
