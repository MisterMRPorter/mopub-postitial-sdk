...
public class HtmlBanner extends CustomEventBanner {
    ...
    protected void loadBanner(
        ...
        mHtmlBannerWebView.getHtmlWebViewClient().setHolder(adViewController.getHolder());
        adViewController.setHtmlWebViewClient(mHtmlBannerWebView.getHtmlWebViewClient());       
        mHtmlBannerWebView.getHtmlWebViewClient().timerStart();        
        mHtmlBannerWebView.getHtmlWebViewClient().setAdViewController(adViewController);       
