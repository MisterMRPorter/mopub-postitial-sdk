...
public class MoPubInterstitial implements CustomEventInterstitialAdapter.CustomEventInterstitialAdapterListener {
    ...
    public MoPubInterstitial(Context context, String id) {
        ...
        adViewController = mInterstitialView.getAdViewController();
    ...
    private View showCustomEventInterstitialView(ViewGroup holder) {
        if (mCustomEventInterstitialAdapter != null) {
            return mCustomEventInterstitialAdapter.showInterstitialView(holder, adViewController);
        }
        else {
            return null;
        }
	...
	public void setPostitial(boolean isPostitial) {
		this.mInterstitialView.mAdViewController.setPostitial(isPostitial);
	}
